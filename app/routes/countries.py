...
from app.models import Joueur, Tournoi, Resultat, ClassementHistorique
from app.ranking import lundi_semaine, tournois_actifs, FREEZE_DEBUT, FREEZE_FIN
...
def pays_detail(
    ...
    from app.models import SerieChampionnat
